...
import ChatDrawer from "../../views/application/chat/ChatDrawer";
import ChartHistory from "../../views/application/chat/ChartHistory";
import AvatarStatus from "../../views/application/chat/AvatarStatus";
...
import {
  ...
  gridSpacing,
} from "store/slices/legacy/constant";
...
const ChatMainPage = () => {
  ...
  const [anchorElEmoji, setAnchorElEmoji] =
    React.useState<any>(); /** No single type can cater for all elements */
                ...
                <Grid item xs={12}>
                  <Grid container alignItems="center" spacing={0.5}>
                    ...
                    <Grid item>
                      <IconButton
                        size="large"
                        aria-label="chat user video call"
                      >
