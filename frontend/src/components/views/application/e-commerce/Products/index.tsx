...
import SkeletonProductPlaceholder from 'components/ui/cards/Skeleton/ProductPlaceholder';
...
import { appDrawerWidth, gridSpacing } from 'store/slices/legacy/constant';
import { getProducts, filterProducts } from 'store/slices/legacy/product';
